...
public class mojapiataaplikacja {
    public static void main(String[] args) {
        // Wywołanie metody do wydrukowania znaku
        printCharacter('*', 5, 3); // Przykład wydrukuj znak * 5 razy w 3 liniach
    }

    // Metoda do drukowania znaku
    private static void printCharacter(char character, int times, int lines) {
